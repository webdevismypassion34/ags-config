...
export function BatteryButton({ gdkmonitor }: { gdkmonitor: Gdk.Monitor }) {
...
export function BatteryPopup({ gdkmonitor }: { gdkmonitor: Gdk.Monitor }) {
  return (
    <Popup
        ...
        <Gtk.DrawingArea
          ...
          $={(self) => {
            self.set_draw_func((_, cr, w, h) => {
              ...
              cr.setLineWidth(12)
              cr.setSourceRGBA(0.192156863, 0.196078431, 0.266666667, 0.4)
              cr.arc(cx, cy, r, 0, 2 * Math.PI)
              cr.stroke()
              cr.setSourceRGBA(0.192156863, 0.196078431, 0.266666667, 1)
              cr.arc(
                cx,
                cy,
                r,
